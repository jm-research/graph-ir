...
/// VertexListGraphConcept
inline
std::pair<typename boost::graph_traits<graphir::Graph>::vertex_iterator,
...
// SubGraph
inline
std::pair<typename boost::graph_traits<graphir::SubGraph>::vertex_iterator,
...
/// EdgeListGraphConcept
inline
std::pair<typename boost::graph_traits<graphir::Graph>::edge_iterator,
...
// SubGraph
inline
std::pair<typename boost::graph_traits<graphir::SubGraph>::edge_iterator,
...
inline typename boost::graph_traits<graphir::Graph>::edges_size_type
num_edges(graphir::Graph& g) {
  return const_cast<const graphir::Graph&>(g).edge_size();
}
inline typename boost::graph_traits<graphir::Graph>::edges_size_type
num_edges(const graphir::Graph& g) {
  return g.edge_size();
}
// SubGraph
...
get(const typename graphir::graph_id_map<GraphT,boost::vertex_index_t> &pmap,
    const typename graphir::graph_id_map<GraphT,boost::vertex_index_t>::key_type
    &key) {
  return pmap[key];
}
